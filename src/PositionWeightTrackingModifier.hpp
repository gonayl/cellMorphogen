#ifndef POSITIONWEIGHTTRACKINGMODIFIER_HPP_
#define POSITIONWEIGHTTRACKINGMODIFIER_HPP_
...
class PositionWeightTrackingModifier : public AbstractCellBasedSimulationModifier<DIM,DIM>
{
...
public:
     ...
     * Default constructor.
     */
    PositionWeightTrackingModifier();

    /**
     * Destructor.
     */
    virtual ~PositionWeightTrackingModifier();
...
#endif /*POSITIONWEIGHTTRACKINGMODIFIER_HPP_*/
