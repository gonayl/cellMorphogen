#ifndef NEWENDOGENERATORMODIFIER_HPP_
#define NEWENDOGENERATORMODIFIER_HPP_
...
class NewEndoGeneratorModifier : public AbstractCellBasedSimulationModifier<DIM,DIM>
{
...
public:
     ...
     * Default constructor.
     */
    NewEndoGeneratorModifier();

    /**
     * Destructor.
     */
    virtual ~NewEndoGeneratorModifier();
...
#endif /*NEWENDOGENERATORMODIFIER_HPP_*/
