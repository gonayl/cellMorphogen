#ifndef POSITIONWEIGHTCONSTANTTRACKINGMODIFIER_HPP_
#define POSITIONWEIGHTCONSTANTTRACKINGMODIFIER_HPP_
...
class PositionWeightConstantTrackingModifier : public AbstractCellBasedSimulationModifier<DIM,DIM>
{
...
public:
     ...
     * Default constructor.
     */
    PositionWeightConstantTrackingModifier();

    /**
     * Destructor.
     */
    virtual ~PositionWeightConstantTrackingModifier();
...
#endif /*PositionWeightConstantTrackingModifier_HPP_*/
