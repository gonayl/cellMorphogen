#ifndef CALIBRATIONERRORMODIFIER_HPP_
#define CALIBRATIONERRORMODIFIER_HPP_
...
class CalibrationErrorModifier : public AbstractCellBasedSimulationModifier<DIM,DIM>
{
...
public:
     ...
     * Default constructor.
     */
    CalibrationErrorModifier();

    /**
     * Destructor.
     */
    virtual ~CalibrationErrorModifier();
...
#endif /*CALIBRATIONERRORMODIFIER_HPP_*/
