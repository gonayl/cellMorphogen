#ifndef RADIUSTRACKINGMODIFIER_HPP_
#define RADIUSTRACKINGMODIFIER_HPP_
...
class RadiusTrackingModifier : public AbstractCellBasedSimulationModifier<DIM,DIM>
{
...
public:
     ...
     * Default constructor.
     */
    RadiusTrackingModifier();

    /**
     * Destructor.
     */
    virtual ~RadiusTrackingModifier();
...
#endif /*RADIUSTRACKINGMODIFIER_HPP_*/
