#ifndef POSITIONTRACKINGMODIFIER_HPP_
#define POSITIONTRACKINGMODIFIER_HPP_
...
class PositionTrackingModifier : public AbstractCellBasedSimulationModifier<DIM,DIM>
{
...
public:
     ...
     * Default constructor.
     */
    PositionTrackingModifier();

    /**
     * Destructor.
     */
    virtual ~PositionTrackingModifier();
...
#endif /*POSITIONTRACKINGMODIFIER_HPP_*/
