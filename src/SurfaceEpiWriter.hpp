#ifndef SURFACEEPIWRITER_HPP_
#define SURFACEEPIWRITER_HPP_
 ...
 *
 * The output file is called SurfaceEpis.dat by default.
 */
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
class SurfaceEpiWriter : public AbstractCellPopulationWriter<ELEMENT_DIM, SPACE_DIM>
{
private:
