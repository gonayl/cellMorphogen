#ifndef SURFACEENDOWRITER_HPP_
#define SURFACEENDOWRITER_HPP_
 ...
 *
 * The output file is called SurfaceEndos.dat by default.
 */
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
class SurfaceEndoWriter : public AbstractCellPopulationWriter<ELEMENT_DIM, SPACE_DIM>
{
private:
