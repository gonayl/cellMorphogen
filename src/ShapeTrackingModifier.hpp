#ifndef SHAPETRACKINGMODIFIER_HPP_
#define SHAPETRACKINGMODIFIER_HPP_
...
class ShapeTrackingModifier : public AbstractCellBasedSimulationModifier<DIM,DIM>
{
...
public:
     ...
     * Default constructor.
     */
    ShapeTrackingModifier();

    /**
     * Destructor.
     */
    virtual ~ShapeTrackingModifier();
...
#endif /*SHAPETRACKINGMODIFIER_HPP_*/
