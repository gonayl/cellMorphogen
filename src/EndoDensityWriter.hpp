#ifndef ENDODENSITYWRITER_HPP_
#define ENDODENSITYWRITER_HPP_
 ...
 *
 * The output file is called EndoDensitys.dat by default.
 */
template<unsigned ELEMENT_DIM, unsigned SPACE_DIM>
class EndoDensityWriter : public AbstractCellPopulationWriter<ELEMENT_DIM, SPACE_DIM>
{
private:
