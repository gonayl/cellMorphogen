#ifndef LABELTRACKINGMODIFIER_HPP_
#define LABELTRACKINGMODIFIER_HPP_
...
class LabelTrackingModifier : public AbstractCellBasedSimulationModifier<DIM,DIM>
{
...
public:
     ...
     * Default constructor.
     */
    LabelTrackingModifier();

    /**
     * Destructor.
     */
    virtual ~LabelTrackingModifier();
...
#endif /*LABELTRACKINGMODIFIER_HPP_*/
