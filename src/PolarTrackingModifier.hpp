#ifndef POLARTRACKINGMODIFIER_HPP_
#define POLARTRACKINGMODIFIER_HPP_
...
class PolarTrackingModifier : public AbstractCellBasedSimulationModifier<DIM,DIM>
{
...
public:
     ...
     * Default constructor.
     */
    PolarTrackingModifier();

    /**
     * Destructor.
     */
    virtual ~PolarTrackingModifier();
...
#endif /*POLARTRACKINGMODIFIER_HPP_*/
