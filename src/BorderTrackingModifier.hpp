#ifndef BORDERTRACKINGMODIFIER_HPP_
#define BORDERTRACKINGMODIFIER_HPP_
...
class BorderTrackingModifier : public AbstractCellBasedSimulationModifier<DIM,DIM>
{
...
public:
     ...
     * Default constructor.
     */
    BorderTrackingModifier();

    /**
     * Destructor.
     */
    virtual ~BorderTrackingModifier();
...
#endif /*BorderTrackingModifier_HPP_*/
