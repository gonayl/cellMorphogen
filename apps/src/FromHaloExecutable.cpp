...
void SetupAndRunSimulation(unsigned mEpiEpi, unsigned mEndoEpi, unsigned mLumenEpi);
...
void SetupAndRunSimulation(unsigned mEpiEpi, unsigned mEndoEpi, unsigned mLumenEpi)
{
  ...
  cout << boundary_input.size() << endl ;
        ...
        p_polarisation_modifier->SetEpiEpiPolarisationParameter(mEpiEpi);
        p_polarisation_modifier->SetEndoEpiPolarisationParameter(mEndoEpi);
        p_polarisation_modifier->SetLumenEpiPolarisationParameter(mLumenEpi);
        ...
        cout << "Testing parameters : (" << mEpiEpi << ";" << mEndoEpi << ";" << mLumenEpi << ")" << endl;

        // Specify output directory (unique to each simulation)
        std::string output_directory = std::string("TestLumenCalibraiton/")
        + std::string("_Ep") + boost::lexical_cast<std::string>(mEpiEpi)
        + std::string("_En") + boost::lexical_cast<std::string>(mEndoEpi)
        + std::string("_L") + boost::lexical_cast<std::string>(mLumenEpi);
